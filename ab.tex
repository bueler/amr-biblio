...
\begin{itemize}
\nm{AinsworthOdenLee1993} Variational inequalities are are discussed in section 6.3. In this analysis they use $K_x \subset K \cap X$ (6.90) and heavily rely on the optimization formulation to bound the global error (6.95). The analysis reduces to solving a VI on each element (6.3.3) the final two paragraphs conclude that the complementarity condition complicate the local problems and they cite 
...
\nm{NochettoSiebertVeeser2003} FIXME
\rnm{Veeser2001} FIXME
